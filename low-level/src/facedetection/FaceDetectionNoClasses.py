...
#GPU_Canny_image = cuda.to_device(AllCannyWindow_np)
#
...
#
#DetectFace[blockperthread, threadsperblock](GPU_stages,GPU_features,GPU_my_stages_threshold_np,GPU_WINDOW_SIZE,GPU_stage_classifiers_count,GPU_AllWindows_np,GPU_AllWindow_Squard,GPU_face_indexes,GPU_Canny_image)
