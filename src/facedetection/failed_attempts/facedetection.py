...
xml_path = join(
    curr_dir, r"./high-level/haar-cascades/haarcascade_frontalface_default.xml"
)
...
while scale < maxScale:
    ...
    rect_values = [feature.get_bounds(scale) for feature in features]
